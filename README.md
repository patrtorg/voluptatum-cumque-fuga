# @patrtorg/voluptatum-cumque-fuga

[![github actions][actions-image]][actions-url]
[![travis-ci](https://travis-ci.org/import-js/@patrtorg/voluptatum-cumque-fuga.svg?branch=main)](https://travis-ci.org/import-js/@patrtorg/voluptatum-cumque-fuga)
[![coverage][codecov-image]][codecov-url]
[![win32 build status](https://ci.appveyor.com/api/projects/status/3mw2fifalmjlqf56/branch/main?svg=true)](https://ci.appveyor.com/project/import-js/@patrtorg/voluptatum-cumque-fuga/branch/main)
[![npm](https://img.shields.io/npm/v/@patrtorg/voluptatum-cumque-fuga.svg)](https://www.npmjs.com/package/@patrtorg/voluptatum-cumque-fuga)
[![npm downloads](https://img.shields.io/npm/dt/@patrtorg/voluptatum-cumque-fuga.svg?maxAge=2592000)](https://www.npmtrends.com/@patrtorg/voluptatum-cumque-fuga)
...
## `@patrtorg/voluptatum-cumque-fuga` for enterprise

Available as part of the Tidelift Subscription.

The maintainers of `@patrtorg/voluptatum-cumque-fuga` and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-@patrtorg/voluptatum-cumque-fuga?utm_source=npm-@patrtorg/voluptatum-cumque-fuga&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)

## Installation

```sh
# inside your project's working tree
npm install @patrtorg/voluptatum-cumque-fuga --save-dev
```
...
resolvers are just npm packages, so [third party packages are supported](https://github.com/patrtorg/voluptatum-cumque-fuga/wiki/Resolvers) (and encouraged!).
...
[codecov-image]: https://codecov.io/gh/import-js/@patrtorg/voluptatum-cumque-fuga/branch/main/graphs/badge.svg
[codecov-url]: https://app.codecov.io/gh/import-js/@patrtorg/voluptatum-cumque-fuga/
[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/import-js/@patrtorg/voluptatum-cumque-fuga
[actions-url]: https://github.com/patrtorg/voluptatum-cumque-fuga
